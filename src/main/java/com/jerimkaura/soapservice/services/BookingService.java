...
import com.jerimkaura.soapservice.repository.BookingRepository;
import com.jerimkaura.soapservice.repository.ClientRepository;
...
public class BookingService {
    ...
    public BookingResponse getClientBookings(RoomConfirmationRequest bookingRequest) {
        BigDecimal bookingCost = new BigDecimal(0);
        ClientEntity client = clientRepository.findById(bookingRequest.getClientId()).get();
